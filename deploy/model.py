...
#Seta e Limpa os datasets
training_df = pd.read_csv("../data/Training.csv")
testing_df = pd.read_csv("../data/Testing.csv")
del training_df["Unnamed: 133"]

#Treina o modelo com base nas features (sintomas) definidos
...
#Testa o modelo armazenado no Pickle
pred_Y = o_modelo.predict(testing_df[features])
print(o_modelo.score(X, Y))
